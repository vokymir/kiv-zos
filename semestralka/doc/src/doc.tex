...
Tato třída nabízí metody pro práci se systémem, jak elementární funkčnost (například \command{inode_create}) tak komplexnější (například \command{file_create}),
...
operací se zapíše nová velikost do i-uzlu. Konzistence dat je zajištěna dopředným načtením všech existujících klastrů a jejich zápis ve stejném pořadí.
